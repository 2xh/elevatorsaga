...
var challenges = [
    {options: {floorCount: 3, elevatorCount: 1, spawnRate: 12.0, elevatorCapacities: [150]}, condition: requireUserCountWithinTime(550, 60)}
    ...
    ,{options: {floorCount: 13, elevatorCount: 2, spawnRate: 1.1, elevatorCapacities: [6, 10]}, condition: requireUserCountWithinTime(50, 75)}
    ,{options: {floorCount: 12, elevatorCount: 4, spawnRate: 1.7, elevatorSpeeds: [8]}, condition: requireUserCountWithinTime(100, 68)}
    ,{options: {floorCount: 4, elevatorCount: 2, spawnRate: 0.8}, condition: requireUserCountWithinMoves(75, 35)}
    ,{options: {floorCount: 10, elevatorCount: 4, spawnRate: 2.0, elevatorCapacities: [8, 12]}, condition: requireUserCountWithinMoves(200, 100)}
    ,{options: {floorCount: 6, elevatorCount: 2, spawnRate: 0.4, elevatorSpeeds: [5], lobbyPossibility: 0.8}, condition: requireUserCountWithMaxWaitTime(50, 18)}
    ...
    ,{options: {floorCount: 13, elevatorCount: 5, spawnRate: 1.2, elevatorCapacities: [8], elevatorSpeeds: [6], lobbyPossibility: 0.8}, condition: requireUserCountWithMaxWaitTime(110, 17)}
    ...
    ,{options: {floorCount: 21, elevatorCount: 4, spawnRate: 1.8, elevatorCapacities: [8], elevatorSpeeds: [4, 8], lobbyPossibility: 0.8}, condition: requireUserCountWithinTime(250, 180)}
    ,{options: {floorCount: 21, elevatorCount: 5, spawnRate: 2.0, elevatorCapacities: [10], elevatorSpeeds: [4, 8], lobbyPossibility: 0.2}, condition: requireUserCountWithinTimeWithMaxWaitTime(200, 120, 45)}
    ...
    ,{options: {floorCount: 100, elevatorCount: 16, spawnRate: 4.8, elevatorCapacities: [8, 10], elevatorSpeeds: [11, 9]}, condition: requireDemo()}
